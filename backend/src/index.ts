...
const apiModules = [
  ...
  },
  {
    ...
    description: "Fetch latest news from 19 sources: ST, CNA, BBC, CNN, Mothership, Al Jazeera, ABC, WaPo, AP News, Fox News, Reuters, CBS, NYT, MS NOW, WSJ, The Guardian, TIME, Sky News, and NPR.",
    status: "active",
    endpointsCount: 19,
  }
];

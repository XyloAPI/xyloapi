...
const apiModules = [
  ...
  },
  {
    ...
    description: "Fetch latest local news from Indonesian sources: Detik News, Kompas News, CNN Indonesia, Liputan6 News, Sindonews, Antara News, BMKG News, Tempo, and Bisnis.com.",
    status: "active",
    endpointsCount: 9,
  }
];

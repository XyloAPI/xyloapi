...
const apiModules = [
  ...
  },
  {
    ...
    description: "Fetch latest news from 16 sources: ST, CNA, BBC, CNN, Mothership, Al Jazeera, ABC, WaPo, AP News, Fox News, Reuters, CBS, NYT, MS NOW, WSJ, and The Guardian.",
    status: "active",
    endpointsCount: 16,
  }
];

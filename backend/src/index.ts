...
const apiModules = [
  ...
  },
  {
    ...
    description: "Fetch latest news from 17 sources: ST, CNA, BBC, CNN, Mothership, Al Jazeera, ABC, WaPo, AP News, Fox News, Reuters, CBS, NYT, MS NOW, WSJ, The Guardian, and TIME.",
    status: "active",
    endpointsCount: 17,
  }
];

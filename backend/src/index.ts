...
const apiModules = [
  ...
  },
  {
    ...
    description: "Fetch latest news from 20 sources: ST, CNA, BBC, CNN, Mothership, Al Jazeera, ABC, WaPo, AP News, Fox News, Reuters, CBS, NYT, MS NOW, WSJ, The Guardian, TIME, Sky News, NPR, and Bloomberg.",
    status: "active",
    endpointsCount: 20,
  }
];

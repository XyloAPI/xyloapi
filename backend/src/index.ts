...
const apiModules = [
  ...
  },
  {
    ...
    description: "Fetch latest news from 21 sources: ST, CNA, BBC, CNN, Mothership, Al Jazeera, ABC, WaPo, AP News, Fox News, Reuters, CBS, NYT, MS NOW, WSJ, The Guardian, TIME, Sky News, NPR, Bloomberg, and The Times.",
    status: "active",
    endpointsCount: 21,
  }
];

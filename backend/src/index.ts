...
const apiModules = [
  ...
  },
  {
    ...
    description: "Fetch latest news from 24 sources: ST, CNA, BBC, CNN, Mothership, Al Jazeera, ABC, WaPo, AP News, Fox News, Reuters, CBS, NYT, MS NOW, WSJ, The Guardian, TIME, Sky News, NPR, Bloomberg, The Times, DW, NHL, and News24.",
    status: "active",
    endpointsCount: 24,
  }
];

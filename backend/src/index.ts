...
const apiModules = [
  ...
  },
  {
    ...
    description: "Fetch latest news from 18 sources: ST, CNA, BBC, CNN, Mothership, Al Jazeera, ABC, WaPo, AP News, Fox News, Reuters, CBS, NYT, MS NOW, WSJ, The Guardian, TIME, and Sky News.",
    status: "active",
    endpointsCount: 18,
  }
];

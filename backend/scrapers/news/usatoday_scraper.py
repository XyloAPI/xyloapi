...
CATEGORIES = {
    "top":           ("Top Stories",      "site:usatoday.com/story"),
    "national":      ("National News",    "site:usatoday.com/story/news"),
    "politics":      ("Politics",         "site:usatoday.com/story/news/politics"),
    "world":         ("World News",       "site:usatoday.com/story/news/world"),
    "sports":        ("Sports",           "site:usatoday.com/story/sports"),
    "entertainment": ("Entertainment",    "site:usatoday.com/story/entertainment"),
    "business":      ("Business & Money", "site:usatoday.com/story/money"),
}
...
def _clean_title(title: str) -> str:
    title = re.sub(r'\s*[-–]\s*USA\s*Today\s*$', '', title, flags=re.I)
    return title.strip()


def get_usatoday(payload):
    ...
    for item in channel.findall("item"):
        ...
        if source_name and "usa today" not in source_name.lower():
            continue

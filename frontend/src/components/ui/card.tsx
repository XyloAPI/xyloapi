...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "bg-dark-iron border border-border-color text-white rounded-none shadow-md transition-all duration-300 hover:border-gold/20",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "font-display text-lg font-bold leading-none tracking-tight uppercase",
      className
    )}
    {...props}
  />

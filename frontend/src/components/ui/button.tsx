...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = "default", size = "default", asChild = false, ...props }, ref) => {
    ...
    return (
      <Comp
        className={cn(
          "inline-flex items-center justify-center whitespace-nowrap text-xs font-mono font-bold tracking-[0.05em] uppercase transition-all duration-200 outline-none disabled:pointer-events-none disabled:opacity-50 cursor-pointer rounded-none select-none",
          // Variants
          ...
          variant === "destructive" && "bg-[#FF3B30] text-white hover:bg-[#e03126] active:bg-[#c9241b]",

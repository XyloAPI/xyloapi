                ...
                <div className="sandbox-panel" style={{ marginTop: '0px' }}>
                  <div className="sandbox-panel-header" style={{ padding: '0px' }}>
                    <div style={{ display: 'flex' }}>
                      <button onClick={() => setResponseTab('visual')} className="nav-link" style={{ padding: '10px 16px', background: responseTab === 'visual' ? 'var(--dark-iron)' : 'transparent', color: responseTab === 'visual' ? 'var(--white)' : 'var(--ash)', border: 'none', borderRight: '1px solid var(--border-color)', fontSize: '10px', fontWeight: 700, cursor: 'pointer', borderRadius: '0px' }}>PREVIEW</button>
                      <button onClick={() => setResponseTab('json')} className="nav-link" style={{ padding: '10px 16px', background: responseTab === 'json' ? 'var(--dark-iron)' : 'transparent', color: responseTab === 'json' ? 'var(--white)' : 'var(--ash)', border: 'none', borderRight: '1px solid var(--border-color)', fontSize: '10px', fontWeight: 700, cursor: 'pointer', borderRadius: '0px' }}>RAW JSON</button>
                    </div>
